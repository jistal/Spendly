...
public class MainController {
    ...
    @FXML private HBox topLabelsHBOX;
    ...
    public void showTopLabelsHBOX(){topLabelsHBOX.setVisible(true);}
    public void hideTopLabelsHBOX(){topLabelsHBOX.setVisible(false);}
    ...
    @FXML public void initialize() {
        ...
        buttonsController.setMenuManager(menuManager);
            ...
            if (topLabelsHBOX != null) topLabelsHBOX.setVisible(false);
